...
const DB = (() => {
  ...
  const KEYS = {
    ...
    cargosEntrega:     PREFIX + 'cargos_entrega',     // actas de entrega de equipos a supervisores
  ...
  const cargosEntrega        = makeCRUD('cargosEntrega');
  ...
  return {
    ...
    inventario, movimientosInventario, cargosEntrega,
